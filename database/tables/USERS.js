...
const TABLE  = "users";
const COLUMNS = ["id","uuid","access_level","email_verified","created_dt","changed_dt","deleted","gender","first_name","last_name","email","password","phone_number"];
...
module.exports = { get, getById, getMe, count, create, update, remove };
