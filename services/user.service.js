...
// Minimum delay (in seconds) between two 2FA code requests to prevent abuse/spam
const A2F_COOLDOWN_SECONDS = 60;

// Maximum number of password reset requests allowed per user per day
const DAILY_RESET_PASSWORD = 3;

// Maximum number of failed login attempts allowed every 15 minutes;
 ...
 * 
 * @async
 * @param {{ email: String, subject: String, content: String }}
 */
